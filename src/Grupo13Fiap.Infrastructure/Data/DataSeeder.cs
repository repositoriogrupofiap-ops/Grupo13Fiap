...
{
    private const string User1IdentityId = "seed-user-joao-silva-0000000001";
    private const string User2IdentityId = "seed-user-maria-souza-0000000002";
    ...
    public static async Task SeedAsync(DBContextGrupo13Fiap context)
    {
        ...
        var user1 = new User("João Silva", User1IdentityId);
        user1.AssignLibrary(library1);

        var user2 = new User("Maria Souza", User2IdentityId);
